...
import CustomToggle from '../../../utils/dropdowns'
...
const Header = memo((props) => {
   ...
   const minisidebar =() =>{
    ...
    return (
        <Fragment>
            <Navbar expand="lg" variant="light" className={`nav iq-navbar ${headerNavbar || ""} 
                        ...
                        <Nav as="ul" className="mb-2 ms-auto navbar-list mb-lg-0 align-items-center">
                            ...
                            <Dropdown as="li" className="nav-item">
                                ...
                                <Dropdown.Menu  className="dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <Dropdown.Item href="/dashboard/special-pages/profile">Profile</Dropdown.Item>
                                    ...
                                    <Dropdown.Divider />
                                    <Dropdown.Item href="/dashboard/auth/sign-in">Logout</Dropdown.Item>
                                </Dropdown.Menu>
                            </Dropdown>
                        </Nav>
                    </Navbar.Collapse>
